...
SPECTACULAR_SETTINGS = {
    "TITLE": "Begum Shahanara Smart Campus API",
    "DESCRIPTION": "Mission-control API for the AI-first educational ecosystem.",
    "VERSION": "1.0.0",
}

REDIS_URL = os.getenv("REDIS_URL", "redis://127.0.0.1:6379/1")
ENABLE_REALTIME_PUSH = os.getenv("ENABLE_REALTIME_PUSH", "false").lower() == "true"
